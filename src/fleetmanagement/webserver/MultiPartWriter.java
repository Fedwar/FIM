//This file is taken from jersey-multipart-1.19
//Only UTF-8 support has been added in line 124!
...
public class MultiPartWriter implements MessageBodyWriter<MultiPart> {
    ...
    public void writeTo(MultiPart entity, Class<?> type, Type genericType,
        ...
        final MediaType boundaryMediaType = getBoundaryMediaType(mediaType);
	...
	protected MediaType getBoundaryMediaType(MediaType mediaType) {
		return Boundary.addBoundary(mediaType);
	}
}
